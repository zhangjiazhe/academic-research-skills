...
- Does not define Zotero / Obsidian / folder-scan adapter shapes (defined in [`academic-research-workflow/references/adapters/overview.md`](adapters/overview.md) from v3.6.4+).
...
- [`academic-research-workflow/agents/pipeline_orchestrator_agent.md`](../agents/pipeline_orchestrator_agent.md) — orchestrator integration
- [`academic-research-workflow/references/pipeline_state_machine.md`](pipeline_state_machine.md) — state transitions
