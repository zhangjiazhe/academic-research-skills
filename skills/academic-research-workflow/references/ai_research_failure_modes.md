...
**Status**: v3.2
**Parent skill**: `academic-research-workflow`
...
- ARS `academic-research-workflow/references/claim_verification_protocol.md` — existing integrity verification that this checklist extends.
- ARS `academic-research-workflow/references/integrity_review_protocol.md` — existing integrity review protocol that Stage 2.5 follows.
